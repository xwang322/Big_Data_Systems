...
/*
        ...
        .setAppName("CS838-Assignment3-PartB-App2-Q2")
...
*/
		...
		*/
		...
		//var output = graph.outDegrees.reduce( (a, b) => if (a._2 > b._2) a else b )
		val vertx_wsize = vertx.map(line => (line._1.toLong, line._2.size))
		val vertx_odegr = graph.outDegrees
		val joined = vertx_odegr.join(vertx_wsize)
		val res = joined.reduce( 
			(a, b) => 
			if (a._2._1 > b._2._1) {
				a
		...
		var w = res._2._2
		var o = res._2._1
		println(s"Assignment3 Part-B Application-2 Question 2")
		println(s"The most popular vertex is the vertex with ID $v has $o edges to its neighbors and has maximum $w words")
//	}
//}
